      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-black">
        ...
        <div className="relative z-10 flex flex-col justify-end p-12 text-white">
          ...
          <p className="text-sm text-white/90 drop-shadow-md">
            Access AI-powered traffic management tools and simulations
          </p>
        </div>
      </div>
        ...
        <div className="max-w-sm w-full">
          ...
          <div className="text-center mb-6">
            ...
            <p className="mt-1 text-xs text-gray-600">
              Join the Georgetown Traffic AI Platform
            </p>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div>
              <button
                type="submit"
                disabled={loading}
                className="group relative w-full flex justify-center py-2.5 px-4 border border-transparent text-sm font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loading ? (
